...
Chempy-Widget is hosted on [Binder](https://mybinder.org/), which takes care of all necessary dependencies and allows anybody to interactively used the notebook. 
...
## Author
[Nathan Sandford](http://w.astro.berkeley.edu/~nathan_sandford/)
